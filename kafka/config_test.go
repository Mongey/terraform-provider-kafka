...
func Test_newTLSConfig(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			args: args{
				clientCert:          loadFile(t, "testdata/client.pem"),
				clientKey:           loadFile(t, "testdata/client-encrypted.key"),
				caCert:              loadFile(t, "testdata/ca.pem"),
				clientKeyPassphrase: "abcdefgh",
			},
			wantErr: false,
		},
		{
			...
			args: args{
				clientCert:          loadFile(t, "testdata/client.pem"),
				clientKey:           loadFile(t, "testdata/client.key"),
				caCert:              loadFile(t, "testdata/ca.pem"),
				clientKeyPassphrase: "",
			},
			wantErr: true,
